package com.example.myfoobbeeapp.adapters;
...
import com.example.myfoobbeeapp.databinding.BottomSheetLayoutBinding;
...
public class HomeVerAdapter extends RecyclerView.Adapter<HomeVerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tining.setText(list.get(position).getTiming());
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sheetView.findViewById(R.id.add_to_car).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView imageView;
        TextView name,tining,rating,price;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.ver_img);
            name = itemView.findViewById(R.id.name);
            tining = itemView.findViewById(R.id.timing);
