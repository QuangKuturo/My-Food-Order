package com.example.myfoobbeeapp.fragments;
...
import com.example.myfoobbeeapp.adapters.FeaturedAdapter;
import com.example.myfoobbeeapp.adapters.FeaturedVerAdapter;
import com.example.myfoobbeeapp.models.FeaturedModel;
import com.example.myfoobbeeapp.models.FeaturedVerModel;
...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        featuredVerModelList.add(new FeaturedVerModel(R.drawable.s1,"Featured 1","Description 1", "4.8","10:00 - 8:00"));
        featuredVerModelList.add(new FeaturedVerModel(R.drawable.s2,"Featured 2","Description 2", "4.8","10:00 - 8:00"));
        featuredVerModelList.add(new FeaturedVerModel(R.drawable.s3,"Featured 3","Description 3", "4.8","10:00 - 8:00"));
